        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 md:col-span-11">
                ...
                <div class="w-full max-w-screen-sm mx-auto md:max-w-2xl">
                    ...
                    <div class="flex flex-col md:flex-row bg-white p-4 space-y-4 md:space-y-0 md:gap-x-16 items-start">
                        <!-- Logo / Image -->
                        ...
                        <div class="flex flex-col justify-center text-center md:text-left">
                            ...
                            <div class="flex flex-wrap justify-center md:justify-start gap-x-4 gap-y-1 text-gray-600">
